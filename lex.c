...
typedef enum {
    oddsym= 1, eqlsym = 2, neqsym = 3, lessym = 4, leqsym = 5, gtrsym = 6,  geqsym = 7,
    modsym = 8,  multsym = 9, slashsym = 10, plussym = 11, minussym = 12, lparentsym = 13,
    rparentsym = 14, commasym = 15, periodsym = 16, semicolonsym = 17, becomessym = 18,
    beginsym = 19, endsym = 20, ifsym = 21, thensym = 22, elsesym = 23, whilesym = 24,
    dosym = 25, callsym = 26, writesym = 27, readsym = 28, constsym = 29, varsym = 30,
...
//For Reserved Words
const char* reservedWords[]={"const", "var", "procedure", "call", "if", "then", "else",
                             "while", "do", "begin", "end", "read", "write", "odd"};
